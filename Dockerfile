...
RUN wget https://github.com/LiveHelperChat/livehelperchat/archive/refs/tags/1.95.zip -O /tmp/source.zip \
  && unzip /tmp/source.zip -d /tmp/source/ \
  && mv /tmp/source/livehelperchat-1.95/lhc_web/* /var/www/html/ \
