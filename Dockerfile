...
RUN wget https://github.com/LiveHelperChat/livehelperchat/archive/refs/tags/2.10v.zip -O /tmp/source.zip \
  && unzip /tmp/source.zip -d /tmp/source/ \
  && mv /tmp/source/livehelperchat-2.10v/lhc_web/* /var/www/html/ \
