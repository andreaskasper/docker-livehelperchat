...
RUN wget https://github.com/LiveHelperChat/livehelperchat/archive/refs/tags/2.0.zip -O /tmp/source.zip \
  && unzip /tmp/source.zip -d /tmp/source/ \
  && mv /tmp/source/livehelperchat-2.0/lhc_web/* /var/www/html/ \
