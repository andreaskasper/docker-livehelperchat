...
RUN wget https://github.com/LiveHelperChat/livehelperchat/archive/refs/tags/2.17v.zip -O /tmp/source.zip \
  && unzip /tmp/source.zip -d /tmp/source/ \
  && mv /tmp/source/livehelperchat-2.17v/lhc_web/* /var/www/html/ \
